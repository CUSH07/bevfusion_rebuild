...
import MeanVFE, VoxelResBackBone8x, height_compression
import basebevbackbone, convfuser, transfusion_head
...
class FusionTemplate(nn.Module):
    ...
    def build_backbone_3d(self, model_info_dict):
        ...
        backbone_3d_module = VoxelResBackBone8x.VoxelResBackBone8x(
    ...
    def build_map_to_bev_module(self, model_info_dict):
        ...
        map_to_bev_module = height_compression.HeightCompression(
    ...
    def build_backbone_2d(self, model_info_dict):
        ...
        backbone_2d_module =basebevbackbone.BaseBEVResBackbone(
    ...
    def build_dense_head(self, model_info_dict):
        ...
        dense_head_module = transfusion_head.TransFusionHead(
